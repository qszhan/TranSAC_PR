...
import numpy as np
from utils import load_model, forward_pass, forward_pass_feature
...
if __name__ == "__main__":
    ...
    dataset_all = ['cifar10', 'cifar100', 'food', 'pets', 'cars', 'sun397', 'flowers', 'caltech101', 'aircraft', 'dtd', 'voc2007']
